...
return [
    ...
    'timestamp' => 1513302839,
    'checksum' => 'e75f9b5e4b7276aaede7ed8df6207f44',
    'files' => [
    ...
    'data' => [
        ...
        'index' => [
            ...
            'particles' => [
                ...
                'services' => [
                    'services-3526' => 'HS Bac',
                    'services-5875' => 'HS Trung',
                    'services-9663' => 'HS Nam'
                ],
                'contentcubes' => [
                    'contentcubes-7850' => 'Content Cubes',
                    'contentcubes-6226' => 'Content Cubes'
                ],
                'copyright' => [
        ...
        'layout' => [
            ...
            'layout' => [
                ...
                '/features/' => [
                    0 => [
                        0 => 'services-3526 33.3',
                        1 => 'services-5875 33.3',
                        2 => 'services-9663 33.3'
                    ]
                ],
                '/utility/' => [
                ...
                '/above/' => [
                    0 => [
                        0 => 'contentcubes-7850 50',
                        1 => 'contentcubes-6226 50'
                    ]
                ],
                '/testimonials/' => [
            ...
            'content' => [
                'owlcarousel-2455' => [
                    ...
                    'attributes' => [
                        ...
                        'items' => [
                            0 => [
                                'image' => 'gantry-media://header/1.jpg',
                                'title' => 'Walk ',
                                'desc' => 'Cuộc hành trình ngàn dặm bắt đầu từ một bước chân nhỏ bé',
                                'link' => '',
                                'linktext' => '',
                                'buttonclass' => '',
                                'name' => 'Item 1'
                ...
                'services-3526' => [
                    'title' => 'HS Bac',
                    'attributes' => [
                        'title' => 'Homestay miền Bắc',
                        'css' => [
                            'class' => 'custom_service'
                        ],
                        'icon' => 'fa fa-cab',
                        'description' => 'Những homestay trong khu vực miền Bắc',
                        'route' => '/t/danh-sach-homestay'
                    ],
                    'block' => [
                        'extra' => [
                            0 => [
                                'data-sr' => 'scale up 30% over 1s'
                            ]
                        ]
                    ]
                ],
                'services-5875' => [
                    'title' => 'HS Trung',
                    'attributes' => [
                        'title' => 'Homestay miền Trung',
                        'css' => [
                            'class' => 'custom_service'
                        ],
                        'icon' => 'fa fa-american-sign-language-interpreting',
                        'description' => 'Những homestay trong khu vực miềnTrung',
                        'route' => '/t/danh-sach-homestay'
                    ],
                    'block' => [
                        'extra' => [
                ...
                'services-9663' => [
                    'title' => 'HS Nam',
                    'attributes' => [
                        'title' => 'Homestay miền Nam',
                        'css' => [
                            'class' => 'custom_service'
                        ],
                        'icon' => 'fa fa-area-chart',
                        'description' => 'Những homestay trong khu vực miền Nam',
                        'route' => '/t/homestay-nam'
                    ],
                    'block' => [
                        'extra' => [
                            0 => [
                ...
                'contentcubes-7850' => [
                    ...
                    'attributes' => [
                        ...
                        'items' => [
                            0 => [
                                'image' => 'gantry-media://above/hs1.jpg',
                                'imageposition' => 'left',
                                'label' => 'Top10',
                                'title' => 'Homestay phổ biến',
                                'tags' => [
                                    0 => [
                                        'icon' => 'fa fa-tag',
                                        'link' => '#',
                ...
                'contentcubes-6226' => [
                    ...
                    'attributes' => [
                        ...
                        'items' => [
                            0 => [
                                'image' => 'gantry-media://89542190.jpg',
                                'imageposition' => 'left',
                                'label' => 'Top10',
                                'title' => 'Homestay mới nhất',
                                'tags' => [
                                    0 => [
                                        'icon' => 'fa fa-tag',
                                        'link' => '',
                ...
                'copyright-1736' => [
                    'attributes' => [
                        ...
                        'owner' => 'TML _TMDT',
                        'additional' => [
                            'text' => 'Liên hệ quảng cáo : 0968105262'
                        ]
                    ]
                ],
                'totop-8670' => [
